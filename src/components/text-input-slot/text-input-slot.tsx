...
export const TextInputSlot = component$<TextInputProps>(({ color }) => {
  const colorOptions = {
    alt: "w-12  hover:bg-alt-key-focus md:text-2xl py-[.5rem] bg-alt-key-bg border-alt-key-border border-b-[3px] font-bold rounded-md  md:w-20 text-lg  child:h-full child:w-full text-alt-key-text flex  justify-center",
    normal:
